 ...
 * потребителя. Не влияе на цената.
 *
...
export type RunInput = {
  ...
  /**
   * Какво е поискал човекът с думи — „на плажа", „офис обстановка".
   *
   * По избор. Доставчик, който не приема текст, го пренебрегва; за него
   * пробата излиза същата, както преди да съществува това поле.
   */
  prompt?: string | null;
};
...
export type PollResult = {
  ...
  /** Свободен текст за лога. Никога не се показва на потребителя. */
  detail?: string;
};
