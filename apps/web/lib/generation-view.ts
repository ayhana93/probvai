...
export const ERROR_MESSAGES: Record<string, string> = {
  TIMEOUT: 'Отне прекалено дълго. Пробата ти е върната — пробвай пак.',
  MODERATION: 'Тази снимка не мина проверката. Пробвай с друга.',
  PROVIDER_FAILED: 'Не се получи. Пробата ти е върната — пробвай с друга снимка.',
  PROVIDER_UNAVAILABLE: 'Услугата не отговаря в момента. Пробата ти е върната.',
  PROVIDER_RATE_LIMIT: 'Прекалено много заявки в момента. Пробата ти е върната.',
  PROVIDER_AUTH: 'Нещо при нас не е наред. Пробата ти е върната, вече го гледаме.',
  PROVIDER_BAD_REQUEST: 'Нещо в снимките не се хареса. Пробата ти е върната.',
  INTERNAL: 'Нещо се обърка при нас. Пробата ти е върната.',
};
