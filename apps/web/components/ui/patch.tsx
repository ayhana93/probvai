 ...
 *
 * ⚠ ПАРЧЕТО НЕ СЕ ПОЗИЦИОНИРА ДИРЕКТНО. Текстурите слагат
 *   `position: relative` за наслагването си и то бие `absolute` на Tailwind,
 *   защото стои по-надолу в стиловете. Трябва ли парче на определено място,
 *   обвий го:
 *
 *     <span className="absolute left-2 top-2"><Patch .../></span>
 *
 *   Сложен направо, класът мълчи и парчето излиза съвсем другаде.
 */
