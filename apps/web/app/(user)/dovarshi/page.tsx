        ...
        <Patch material="paper" className="mt-6 px-4 py-4">
          ...
          <div className="mt-3 space-y-2">
            ...
            <Choice
              ...
              title="Публичен"
              /* Нарочно не се казва „в Lookbook": галерията може да е скрита,
                 а този екран се минава веднъж и няма как да пита сървъра за
                 всяко изречение. Написано като ПРАВО, а не като място,
                 изречението е вярно и в двата случая. */
              note="Даваш право избрани проби да се показват публично. Всяка се пуска поотделно, с натискане — нищо не излиза само."
            />
          </div>
